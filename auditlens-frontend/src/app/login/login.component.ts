...
export class LoginComponent {
  ...
  pipelineStages = [
    { label: 'Document Upload', icon: 'ph-upload-simple' },
    { label: 'AI OCR Extraction', icon: 'ph-scan' },
    { label: 'Validation & Three-way Matching', icon: 'ph-arrows-left-right' },
    { label: 'Risk & Anomaly Detection', icon: 'ph-shield-warning' },
    { label: 'AI Audit Assistant', icon: 'ph-robot' },
    { label: 'Auditor Decision', icon: 'ph-gavel' }
  ];

  capabilities = [
    { title: 'AI Document Analysis', desc: 'Extracts and understands invoices, POs, and receipts.', icon: 'ph-magnifying-glass' },
    { title: 'Three-way Matching', desc: 'Reconciles invoices, purchase orders, and goods receipts.', icon: 'ph-arrows-left-right' },
    { title: 'Risk & Exception Detection', desc: 'Flags anomalies before they reach the ledger.', icon: 'ph-shield-warning' },
    { title: 'AI Audit Assistant', desc: 'Answers questions grounded in the audit trail.', icon: 'ph-robot' },
