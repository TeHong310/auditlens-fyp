...
SUITES = ['test_invoice.py', 'test_po.py', 'test_gr.py', 'test_currency.py', 'test_ap_upgrade.py',
          ...
          'test_authenticity_po_gr_auto_trigger.py', 'test_vision_evidence_boxes.py',
          'test_evidence_corrections.py',
          ...
          'test_anomaly_detector.py', 'test_anomaly_decision_mapping.py']
